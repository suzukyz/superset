    ...
    try:
        ...
        if request.dataset_id is not None:
            dataset = load_dataset(
                request.dataset_id, "mcp.get_compatible_dimensions.builtin"
            )
            ...
            dims: list[DimensionInfo] = builtin_dimensions(dataset)
        ...
        view = load_semantic_view(view_id, "mcp.get_compatible_dimensions.external")
